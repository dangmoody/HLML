...
double2x3 double2x3::operator+( const double rhs ) const {
	return double2x3(
		rows[0] + rhs,
		rows[1] + rhs
	);
...
double2x3 double2x3::operator+=( const double rhs ) {
	return ( *this = *this + rhs );
}

double2x3 double2x3::operator+( const double2x3& rhs ) const {
	return double2x3(
		rows[0] + rhs.rows[0],
		rows[1] + rhs.rows[1]
	);
...
double2x3 double2x3::operator+=( const double2x3& rhs ) {
	return ( *this = *this + rhs );
}
