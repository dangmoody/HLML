...
double4x3 double4x3::operator+( const double rhs ) const {
	return double4x3(
		rows[0] + rhs,
		rows[1] + rhs,
		rows[2] + rhs,
...
double4x3 double4x3::operator+=( const double rhs ) {
	return ( *this = *this + rhs );
}

double4x3 double4x3::operator+( const double4x3& rhs ) const {
	return double4x3(
		rows[0] + rhs.rows[0],
		rows[1] + rhs.rows[1],
		rows[2] + rhs.rows[2],
...
double4x3 double4x3::operator+=( const double4x3& rhs ) {
	return ( *this = *this + rhs );
}
