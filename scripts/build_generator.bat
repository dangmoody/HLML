...
set ignore_warnings=-Wno-newline-eof -Wno-microsoft-anon-tag -Wno-double-promotion -Wno-bad-function-cast -Wno-declaration-after-statement  -Wno-missing-braces -Wno-switch-default -Wno-unsafe-buffer-usage
