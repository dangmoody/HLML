...
TEMPER_TEST( TestComponentWiseArithmeticAddition_double3x2 )
{
	// scalar
...
TEMPER_TEST( TestComponentWiseArithmeticSubtraction_double3x2 )
{
	// scalar
	double3x2 answer = double3x2(
		5.000000, 5.000000,
...
TEMPER_TEST( TestComponentWiseArithmeticMultiplication_double3x2 )
{
	// scalar
	double3x2 answer = double3x2(
		6.000000, 6.000000,
...
TEMPER_TEST( TestComponentWiseArithmeticDivision_double3x2 )
{
	// scalar
	double3x2 answer = double3x2(
		6.000000, 6.000000,
...
TEMPER_TEST( TestMultiplyMatrix_double3x2 )
{
	// scalar
...
TEMPER_SUITE( Test_double3x2 )
{
	...
	TEMPER_RUN_TEST( TestComponentWiseArithmeticAddition_double3x2 );
	TEMPER_RUN_TEST( TestComponentWiseArithmeticSubtraction_double3x2 );
	TEMPER_RUN_TEST( TestComponentWiseArithmeticMultiplication_double3x2 );
	TEMPER_RUN_TEST( TestComponentWiseArithmeticDivision_double3x2 );
	TEMPER_RUN_TEST( TestMultiplyMatrix_double3x2 );
