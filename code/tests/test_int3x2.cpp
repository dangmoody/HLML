...
TEMPER_TEST( TestBitwiseAnd_int3x2 )
{
	int3x2 a  = int3x2(
		21, 21,
		21, 21,
...
TEMPER_TEST( TestBitwiseOr_int3x2 )
{
	int3x2 a  = int3x2(
		21, 21,
		21, 21,
...
TEMPER_TEST( TestBitwiseXor_int3x2 )
{
	int3x2 a  = int3x2(
		21, 21,
		21, 21,
...
TEMPER_TEST( TestBitwiseShiftLeft_int3x2 )
{
	int3x2 a  = int3x2(
		1, 1,
		1, 1,
...
TEMPER_TEST( TestBitwiseShiftRight_int3x2 )
{
	int3x2 a  = int3x2(
		16, 16,
		16, 16,
...
TEMPER_TEST( TestBitwiseUnary_int3x2 )
{
	int3x2 a = int3x2(
		0, 0,
		0, 0,
	...
	TEMPER_EXPECT_TRUE( answer == int3x2( (int32_t) -1, (int32_t) -1,
(int32_t) -1, (int32_t) -1,
(int32_t) -1, (int32_t) -1
 ) );
...
TEMPER_SUITE( Test_int3x2 )
{
	...
	TEMPER_RUN_TEST( TestBitwiseAnd_int3x2 );
	TEMPER_RUN_TEST( TestBitwiseOr_int3x2 );
	TEMPER_RUN_TEST( TestBitwiseXor_int3x2 );
	TEMPER_RUN_TEST( TestBitwiseUnary_int3x2 );
	TEMPER_RUN_TEST( TestBitwiseShiftLeft_int3x2 );
	TEMPER_RUN_TEST( TestBitwiseShiftRight_int3x2 );
