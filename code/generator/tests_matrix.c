	...
	testFixture_Inverse_t fixtures[] = {
		{
			...
			.expectedAnswer2x2 = {
				 0.184210526316f,  -0.0526315789474f, -1.0f, -1.0f,
				-0.0526315789474f,  0.157894736842f,  -1.0f, -1.0f,
				-1.0f,             -1.0f,             -1.0f, -1.0f,
				-1.0f,             -1.0f,             -1.0f, -1.0f
			},
			.expectedAnswer3x3 = {
				 0.212389380531f,    0.00884955752212f, -0.0973451327434f, -1.0f,
				 0.00884955752212f,  0.29203539823f,    -0.212389380531f,  -1.0f,
				-0.0973451327434f,  -0.212389380531f,    0.336283185841f,  -1.0f,
				-1.0f,              -1.0f,              -1.0f,             -1.0f
			},
			.expectedAnswer4x4 = {
