...
static void GenerateFunction_Inverse_Matrix( allocatorLinear_t* tempStorage, const typeInfo_t* typeInfo, const typeInfo_t* memberTypeInfo, stringBuilder_t* code, const generatorStrings_t* strings, const generatorFlags_t flags ) {
	...
	switch ( typeInfo->numRows ) {
		...
		case 4: {
			...
			StringBuilder_Appendf( code, "\t%s sub00 = mat%srows[2].z * mat%srows[3].w - mat%srows[3].z * mat%srows[2].w;\n", memberTypeString, strings->parmAccessOperatorStr, strings->parmAccessOperatorStr, strings->parmAccessOperatorStr, strings->parmAccessOperatorStr );
			StringBuilder_Appendf( code, "\t%s sub01 = mat%srows[1].z * mat%srows[3].w - mat%srows[1].w * mat%srows[2].w;\n", memberTypeString, strings->parmAccessOperatorStr, strings->parmAccessOperatorStr, strings->parmAccessOperatorStr, strings->parmAccessOperatorStr );
			StringBuilder_Appendf( code, "\t%s sub02 = mat%srows[1].z * mat%srows[2].w - mat%srows[1].w * mat%srows[2].z;\n", memberTypeString, strings->parmAccessOperatorStr, strings->parmAccessOperatorStr, strings->parmAccessOperatorStr, strings->parmAccessOperatorStr );
			StringBuilder_Append(  code, "\n" );
			StringBuilder_Appendf( code, "\t%s sub03 = mat%srows[2].y * mat%srows[3].w - mat%srows[2].w * mat%srows[3].y;\n", memberTypeString, strings->parmAccessOperatorStr, strings->parmAccessOperatorStr, strings->parmAccessOperatorStr, strings->parmAccessOperatorStr );
			StringBuilder_Appendf( code, "\t%s sub04 = mat%srows[1].y * mat%srows[3].w - mat%srows[1].w * mat%srows[3].y;\n", memberTypeString, strings->parmAccessOperatorStr, strings->parmAccessOperatorStr, strings->parmAccessOperatorStr, strings->parmAccessOperatorStr );
			StringBuilder_Appendf( code, "\t%s sub05 = mat%srows[1].y * mat%srows[2].w - mat%srows[1].w * mat%srows[2].y;\n", memberTypeString, strings->parmAccessOperatorStr, strings->parmAccessOperatorStr, strings->parmAccessOperatorStr, strings->parmAccessOperatorStr );
			StringBuilder_Append(  code, "\n" );
			StringBuilder_Appendf( code, "\t%s sub06 = mat%srows[2].y * mat%srows[3].z - mat%srows[2].z * mat%srows[3].y;\n", memberTypeString, strings->parmAccessOperatorStr, strings->parmAccessOperatorStr, strings->parmAccessOperatorStr, strings->parmAccessOperatorStr );
			StringBuilder_Appendf( code, "\t%s sub07 = mat%srows[1].y * mat%srows[3].z - mat%srows[1].z * mat%srows[3].y;\n", memberTypeString, strings->parmAccessOperatorStr, strings->parmAccessOperatorStr, strings->parmAccessOperatorStr, strings->parmAccessOperatorStr );
			StringBuilder_Appendf( code, "\t%s sub08 = mat%srows[1].y * mat%srows[2].z - mat%srows[1].z * mat%srows[2].y;\n", memberTypeString, strings->parmAccessOperatorStr, strings->parmAccessOperatorStr, strings->parmAccessOperatorStr, strings->parmAccessOperatorStr );
			StringBuilder_Append(  code, "\n" );
			StringBuilder_Appendf( code, "\t%s sub09 = mat%srows[2].x * mat%srows[3].w - mat%srows[3].x * mat%srows[2].w;\n", memberTypeString, strings->parmAccessOperatorStr, strings->parmAccessOperatorStr, strings->parmAccessOperatorStr, strings->parmAccessOperatorStr );
			StringBuilder_Appendf( code, "\t%s sub10 = mat%srows[1].x * mat%srows[3].w - mat%srows[3].x * mat%srows[1].w;\n", memberTypeString, strings->parmAccessOperatorStr, strings->parmAccessOperatorStr, strings->parmAccessOperatorStr, strings->parmAccessOperatorStr );
			StringBuilder_Appendf( code, "\t%s sub11 = mat%srows[1].x * mat%srows[2].w - mat%srows[2].x * mat%srows[1].w;\n", memberTypeString, strings->parmAccessOperatorStr, strings->parmAccessOperatorStr, strings->parmAccessOperatorStr, strings->parmAccessOperatorStr );
			StringBuilder_Append(  code, "\n" );
			StringBuilder_Appendf( code, "\t%s sub12 = mat%srows[2].x * mat%srows[3].z - mat%srows[2].z * mat%srows[3].x;\n", memberTypeString, strings->parmAccessOperatorStr, strings->parmAccessOperatorStr, strings->parmAccessOperatorStr, strings->parmAccessOperatorStr );
			StringBuilder_Appendf( code, "\t%s sub13 = mat%srows[1].x * mat%srows[3].z - mat%srows[1].z * mat%srows[3].x;\n", memberTypeString, strings->parmAccessOperatorStr, strings->parmAccessOperatorStr, strings->parmAccessOperatorStr, strings->parmAccessOperatorStr );
			StringBuilder_Appendf( code, "\t%s sub14 = mat%srows[1].x * mat%srows[2].z - mat%srows[1].z * mat%srows[2].x;\n", memberTypeString, strings->parmAccessOperatorStr, strings->parmAccessOperatorStr, strings->parmAccessOperatorStr, strings->parmAccessOperatorStr );
			StringBuilder_Append(  code, "\n" );
			StringBuilder_Appendf( code, "\t%s sub15 = mat%srows[2].x * mat%srows[3].y - mat%srows[2].y * mat%srows[3].x;\n", memberTypeString, strings->parmAccessOperatorStr, strings->parmAccessOperatorStr, strings->parmAccessOperatorStr, strings->parmAccessOperatorStr );
			StringBuilder_Appendf( code, "\t%s sub16 = mat%srows[1].x * mat%srows[3].y - mat%srows[1].y * mat%srows[3].x;\n", memberTypeString, strings->parmAccessOperatorStr, strings->parmAccessOperatorStr, strings->parmAccessOperatorStr, strings->parmAccessOperatorStr );
			StringBuilder_Appendf( code, "\t%s sub17 = mat%srows[1].x * mat%srows[2].y - mat%srows[1].y * mat%srows[2].x;\n", memberTypeString, strings->parmAccessOperatorStr, strings->parmAccessOperatorStr, strings->parmAccessOperatorStr, strings->parmAccessOperatorStr );
			StringBuilder_Append(  code, "\n" );
			StringBuilder_Appendf( code, "\t%s fac0 = { sub00, sub00, sub01, sub02 };\n", memberTypeInfo->fullTypeName );
			StringBuilder_Appendf( code, "\t%s fac1 = { sub03, sub03, sub04, sub05 };\n", memberTypeInfo->fullTypeName );
			StringBuilder_Appendf( code, "\t%s fac2 = { sub06, sub06, sub07, sub08 };\n", memberTypeInfo->fullTypeName );
			StringBuilder_Appendf( code, "\t%s fac3 = { sub09, sub09, sub10, sub11 };\n", memberTypeInfo->fullTypeName );
			StringBuilder_Appendf( code, "\t%s fac4 = { sub12, sub12, sub13, sub14 };\n", memberTypeInfo->fullTypeName );
			StringBuilder_Appendf( code, "\t%s fac5 = { sub15, sub15, sub16, sub17 };\n", memberTypeInfo->fullTypeName );
			StringBuilder_Append(  code, "\n" );
			...
			if ( flags & GENERATOR_FLAG_GENERATE_OPERATORS ) {
				...
				StringBuilder_Append(  code, "\t);\n" );
				StringBuilder_Append(  code, "\n" );
				StringBuilder_Appendf( code, "\t%s col0 = %s( result.rows[0][0], result.rows[1][0], result.rows[2][0], result.rows[3][0] );\n", memberTypeInfo->fullTypeName, memberTypeInfo->fullTypeName );
				StringBuilder_Appendf( code, "\t%s dot0 = mat.rows[0] * col0;\n", memberTypeInfo->fullTypeName );
				StringBuilder_Append(  code, "\n" );
...
static void GenerateMatrixFiles( allocatorLinear_t* tempStorage, const char* generatedCodePath, const typeInfo_t* typeInfos, const u32 typeInfosCount, const generatorStrings_t* strings, const generatorFlags_t flags ) {
	...
	for ( u32 typeInfoIndex = 0; typeInfoIndex < typeInfosCount; typeInfoIndex++ ) {
		...
		// header file
		{
			stringBuilder_t* codeHeader = StringBuilder_Create( tempStorage, 3 * KB_TO_BYTES );
