...
TEMPER_TEST_PARAMETRIC( Test_double_min, TEMPER_FLAG_SHOULD_RUN, const double lhs, const double rhs, const double expectedAnswer )
{
...
TEMPER_TEST_PARAMETRIC( Test_double_max, TEMPER_FLAG_SHOULD_RUN, const double lhs, const double rhs, const double expectedAnswer )
{
...
TEMPER_TEST_PARAMETRIC( Test_double_saturate, TEMPER_FLAG_SHOULD_RUN, const double x, const double expectedAnswer )
{
...
TEMPER_TEST_PARAMETRIC( Test_double_sign, TEMPER_FLAG_SHOULD_RUN, const double x, const int32_t expectedAnswer )
{
...
TEMPER_TEST_PARAMETRIC( Test_double_doubleeq, TEMPER_FLAG_SHOULD_RUN, const double lhs, const double rhs, const bool expectedAnswer )
{
...
TEMPER_TEST_PARAMETRIC( Test_double_degrees, TEMPER_FLAG_SHOULD_RUN, const double x, const double expectedAnswer )
{
...
TEMPER_TEST_PARAMETRIC( Test_double_radians, TEMPER_FLAG_SHOULD_RUN, const double x, const double expectedAnswer )
{
...
TEMPER_TEST_PARAMETRIC( Test_double_lerp, TEMPER_FLAG_SHOULD_RUN, const double lhs, const double rhs, const double t, const double expectedAnswer )
{
