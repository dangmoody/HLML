...
TEMPER_SUITE( Test_uint4x4 ) {
	...
	TEMPER_RUN_TEST( TestInverse_uint4x4 );
	TEMPER_RUN_TEST( TestDeterminant_uint4x4 );
	TEMPER_RUN_TEST( TestTranslate_uint4x4 );
	TEMPER_RUN_TEST( TestRotate_uint4x4 );
	TEMPER_RUN_TEST( TestScale_uint4x4 );
	TEMPER_RUN_TEST( TestOrtho_uint4x4 );
	TEMPER_RUN_TEST( TestPerspective_uint4x4 );
	TEMPER_RUN_TEST( TestLookAt_uint4x4 );
};
