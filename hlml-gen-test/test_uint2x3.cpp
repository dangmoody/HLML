...
TEMPER_TEST( TestArithmetic_uint2x3 ) {
	TEMPER_FAIL();
}
...
TEMPER_TEST( TestEquality_uint2x3 ) {
	TEMPER_FAIL();
}
...
TEMPER_TEST( TestInverse_uint2x3 ) {
	TEMPER_FAIL();
}

TEMPER_TEST( TestDeterminant_uint2x3 ) {
	TEMPER_FAIL();
}
...
TEMPER_SUITE( Test_uint2x3 ) {
	TEMPER_SKIP_TEST( TestAssignment_uint2x3, "TODO" );
	TEMPER_SKIP_TEST( TestArithmetic_uint2x3, "TODO" );
	TEMPER_SKIP_TEST( TestArray_uint2x3, "TODO" );
	TEMPER_SKIP_TEST( TestEquality_uint2x3, "TODO" );
	TEMPER_SKIP_TEST( TestRelational_uint2x3, "TODO" );

	TEMPER_SKIP_TEST( TestIdentity_uint2x3, "TODO" );
	TEMPER_SKIP_TEST( TestTranspose_uint2x3, "TODO" );

	TEMPER_SKIP_TEST( TestInverse_uint2x3, "TODO" );
	TEMPER_SKIP_TEST( TestDeterminant_uint2x3, "TODO" );
