...
TEMPER_SUITE( Test_uint2x3 ) {
	...
	TEMPER_RUN_TEST( TestInverse_uint2x3 );
	TEMPER_RUN_TEST( TestDeterminant_uint2x3 );
	TEMPER_RUN_TEST( TestTranslate_uint2x3 );
	TEMPER_RUN_TEST( TestRotate_uint2x3 );
	TEMPER_RUN_TEST( TestScale_uint2x3 );
	TEMPER_RUN_TEST( TestOrtho_uint2x3 );
	TEMPER_RUN_TEST( TestPerspective_uint2x3 );
	TEMPER_RUN_TEST( TestLookAt_uint2x3 );
};
