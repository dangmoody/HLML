...
TEMPER_SUITE( Test_double2x4 ) {
	...
	TEMPER_RUN_TEST( TestInverse_double2x4 );
	TEMPER_RUN_TEST( TestDeterminant_double2x4 );
	TEMPER_RUN_TEST( TestTranslate_double2x4 );
	TEMPER_RUN_TEST( TestRotate_double2x4 );
	TEMPER_RUN_TEST( TestScale_double2x4 );
	TEMPER_RUN_TEST( TestOrtho_double2x4 );
	TEMPER_RUN_TEST( TestPerspective_double2x4 );
	TEMPER_RUN_TEST( TestLookAt_double2x4 );
};
