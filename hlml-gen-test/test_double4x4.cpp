...
TEMPER_SUITE( Test_double4x4 ) {
	TEMPER_SKIP_TEST( TestAssignment_double4x4, "TODO" );
	TEMPER_SKIP_TEST( TestArithmetic_double4x4, "TODO" );
	TEMPER_SKIP_TEST( TestArray_double4x4, "TODO" );
	TEMPER_SKIP_TEST( TestEquality_double4x4, "TODO" );
	TEMPER_SKIP_TEST( TestRelational_double4x4, "TODO" );

	TEMPER_SKIP_TEST( TestIdentity_double4x4, "TODO" );
	TEMPER_SKIP_TEST( TestTranspose_double4x4, "TODO" );
