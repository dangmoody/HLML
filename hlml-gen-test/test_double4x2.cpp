...
TEMPER_TEST( TestArithmetic_double4x2 ) {
	TEMPER_FAIL();
}
...
TEMPER_TEST( TestEquality_double4x2 ) {
	TEMPER_FAIL();
}
...
TEMPER_TEST( TestInverse_double4x2 ) {
	TEMPER_FAIL();
}

TEMPER_TEST( TestDeterminant_double4x2 ) {
	TEMPER_FAIL();
}
...
TEMPER_SUITE( Test_double4x2 ) {
	...
	TEMPER_RUN_TEST( TestArithmetic_double4x2 );
	TEMPER_RUN_TEST( TestArray_double4x2 );
	TEMPER_RUN_TEST( TestEquality_double4x2 );
	TEMPER_RUN_TEST( TestRelational_double4x2 );

	TEMPER_RUN_TEST( TestIdentity_double4x2 );
	TEMPER_RUN_TEST( TestTranspose_double4x2 );
	TEMPER_RUN_TEST( TestInverse_double4x2 );
	TEMPER_RUN_TEST( TestDeterminant_double4x2 );
	TEMPER_RUN_TEST( TestTranslate_double4x2 );
	TEMPER_RUN_TEST( TestRotate_double4x2 );
	TEMPER_RUN_TEST( TestScale_double4x2 );
	TEMPER_RUN_TEST( TestOrtho_double4x2 );
	TEMPER_RUN_TEST( TestPerspective_double4x2 );
	TEMPER_RUN_TEST( TestLookAt_double4x2 );
};
