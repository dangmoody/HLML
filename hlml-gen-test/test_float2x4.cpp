...
TEMPER_TEST( TestArithmetic_float2x4 ) {
	TEMPER_FAIL();
}
...
TEMPER_TEST( TestEquality_float2x4 ) {
	TEMPER_FAIL();
}
...
TEMPER_TEST( TestInverse_float2x4 ) {
	TEMPER_FAIL();
}

TEMPER_TEST( TestDeterminant_float2x4 ) {
	TEMPER_FAIL();
}
...
TEMPER_SUITE( Test_float2x4 ) {
	TEMPER_SKIP_TEST( TestAssignment_float2x4, "TODO" );
	TEMPER_SKIP_TEST( TestArithmetic_float2x4, "TODO" );
	TEMPER_SKIP_TEST( TestArray_float2x4, "TODO" );
	TEMPER_SKIP_TEST( TestEquality_float2x4, "TODO" );
	TEMPER_SKIP_TEST( TestRelational_float2x4, "TODO" );

	TEMPER_SKIP_TEST( TestIdentity_float2x4, "TODO" );
	TEMPER_SKIP_TEST( TestTranspose_float2x4, "TODO" );

	TEMPER_SKIP_TEST( TestInverse_float2x4, "TODO" );
	TEMPER_SKIP_TEST( TestDeterminant_float2x4, "TODO" );
