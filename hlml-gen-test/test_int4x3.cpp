...
TEMPER_SUITE( Test_int4x3 ) {
	TEMPER_SKIP_TEST( TestAssignment_int4x3, "TODO" );
	TEMPER_SKIP_TEST( TestArithmetic_int4x3, "TODO" );
	TEMPER_SKIP_TEST( TestArray_int4x3, "TODO" );
	TEMPER_SKIP_TEST( TestEquality_int4x3, "TODO" );
	TEMPER_SKIP_TEST( TestRelational_int4x3, "TODO" );

	TEMPER_SKIP_TEST( TestIdentity_int4x3, "TODO" );
	TEMPER_SKIP_TEST( TestTranspose_int4x3, "TODO" );

	TEMPER_SKIP_TEST( TestInverse_int4x3, "TODO" );
