...
TEMPER_SUITE( Test_double3x4 ) {
	TEMPER_SKIP_TEST( TestAssignment_double3x4, "TODO" );
	TEMPER_SKIP_TEST( TestArithmetic_double3x4, "TODO" );
	TEMPER_SKIP_TEST( TestArray_double3x4, "TODO" );
	TEMPER_SKIP_TEST( TestEquality_double3x4, "TODO" );
	TEMPER_SKIP_TEST( TestRelational_double3x4, "TODO" );

	TEMPER_SKIP_TEST( TestIdentity_double3x4, "TODO" );
	TEMPER_SKIP_TEST( TestTranspose_double3x4, "TODO" );
