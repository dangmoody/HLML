...
TEMPER_TEST( TestNormalized_double3 ) {
	double3 vec = double3( 2.0, 3.0, 4.0 );
	vec = normalized( vec );
...
TEMPER_TEST( TestDot_double3 ) {
	double3 a = double3( 0.0, 0.0, 1.0 );
	double3 b = double3( 0.0, 0.0, -1.0 );
...
TEMPER_TEST( TestCross_double3 ) {
	double3 left = double3( -1.0, 0.0, 0.0 );
	double3 forward = double3( 0.0, 0.0, 1.0 );
