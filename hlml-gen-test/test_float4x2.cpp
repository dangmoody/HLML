...
TEMPER_SUITE( Test_float4x2 ) {
	...
	TEMPER_RUN_TEST( TestArithmetic_float4x2 );
	TEMPER_RUN_TEST( TestArray_float4x2 );
	TEMPER_RUN_TEST( TestEquality_float4x2 );
	TEMPER_RUN_TEST( TestRelational_float4x2 );

	TEMPER_RUN_TEST( TestIdentity_float4x2 );
	TEMPER_RUN_TEST( TestTranspose_float4x2 );
	TEMPER_RUN_TEST( TestInverse_float4x2 );
	TEMPER_RUN_TEST( TestDeterminant_float4x2 );
	TEMPER_RUN_TEST( TestTranslate_float4x2 );
	TEMPER_RUN_TEST( TestRotate_float4x2 );
	TEMPER_RUN_TEST( TestScale_float4x2 );
	TEMPER_RUN_TEST( TestOrtho_float4x2 );
	TEMPER_RUN_TEST( TestPerspective_float4x2 );
	TEMPER_RUN_TEST( TestLookAt_float4x2 );
};
