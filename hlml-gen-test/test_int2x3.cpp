...
TEMPER_TEST( TestArithmetic_int2x3 ) {
	TEMPER_FAIL();
}
...
TEMPER_TEST( TestEquality_int2x3 ) {
	TEMPER_FAIL();
}
...
TEMPER_TEST( TestInverse_int2x3 ) {
	TEMPER_FAIL();
}

TEMPER_TEST( TestDeterminant_int2x3 ) {
	TEMPER_FAIL();
}
...
TEMPER_SUITE( Test_int2x3 ) {
	TEMPER_SKIP_TEST( TestAssignment_int2x3, "TODO" );
	TEMPER_SKIP_TEST( TestArithmetic_int2x3, "TODO" );
	TEMPER_SKIP_TEST( TestArray_int2x3, "TODO" );
	TEMPER_SKIP_TEST( TestEquality_int2x3, "TODO" );
	TEMPER_SKIP_TEST( TestRelational_int2x3, "TODO" );

	TEMPER_SKIP_TEST( TestIdentity_int2x3, "TODO" );
	TEMPER_SKIP_TEST( TestTranspose_int2x3, "TODO" );
	TEMPER_SKIP_TEST( TestInverse_int2x3, "TODO" );
	TEMPER_SKIP_TEST( TestDeterminant_int2x3, "TODO" );
