...
TEMPER_SUITE( Test_int2x3 ) {
	...
	TEMPER_RUN_TEST( TestArithmetic_int2x3 );
	TEMPER_RUN_TEST( TestArray_int2x3 );
	TEMPER_RUN_TEST( TestEquality_int2x3 );
	TEMPER_RUN_TEST( TestRelational_int2x3 );

	TEMPER_RUN_TEST( TestIdentity_int2x3 );
	TEMPER_RUN_TEST( TestTranspose_int2x3 );
	TEMPER_RUN_TEST( TestInverse_int2x3 );
	TEMPER_RUN_TEST( TestDeterminant_int2x3 );
	TEMPER_RUN_TEST( TestTranslate_int2x3 );
	TEMPER_RUN_TEST( TestRotate_int2x3 );
	TEMPER_RUN_TEST( TestScale_int2x3 );
	TEMPER_RUN_TEST( TestOrtho_int2x3 );
	TEMPER_RUN_TEST( TestPerspective_int2x3 );
	TEMPER_RUN_TEST( TestLookAt_int2x3 );
};
