...
TEMPER_SUITE( Test_int3x4 ) {
	...
	TEMPER_RUN_TEST( TestInverse_int3x4 );
	TEMPER_RUN_TEST( TestDeterminant_int3x4 );
	TEMPER_RUN_TEST( TestTranslate_int3x4 );
	TEMPER_RUN_TEST( TestRotate_int3x4 );
	TEMPER_RUN_TEST( TestScale_int3x4 );
	TEMPER_RUN_TEST( TestOrtho_int3x4 );
	TEMPER_RUN_TEST( TestPerspective_int3x4 );
	TEMPER_RUN_TEST( TestLookAt_int3x4 );
};
