...
TEMPER_SUITE( Test_float2x2 ) {
	...
	TEMPER_RUN_TEST( TestTranslate_float2x2 );
	TEMPER_RUN_TEST( TestRotate_float2x2 );
	TEMPER_RUN_TEST( TestScale_float2x2 );
	TEMPER_RUN_TEST( TestOrtho_float2x2 );
	TEMPER_RUN_TEST( TestPerspective_float2x2 );
	TEMPER_RUN_TEST( TestLookAt_float2x2 );
};
