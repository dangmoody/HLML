...
REM path to CL.exe MUST include "CL.exe"
set msvc_path=%1
...
%msvc_path% %source_files_path% %additional_includes% %options_compiler% /link %options_linker% %libs%
